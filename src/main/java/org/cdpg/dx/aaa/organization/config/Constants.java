...
public final class Constants {
  ...
  public static final Map<String, String> ALLOWED_FILTER_MAP_FOR_ORG = Map.ofEntries(
  ...
  public static final Map<String, String> ALLOWED_FILTER_MAP_FOR_ORG_JOIN_REQUEST = Map.ofEntries(
  ...
  public static final Map<String, String> ALLOWED_FILTER_MAP_FOR_ORG_USERS = Map.ofEntries(
          Map.entry("organizationId", ORGANIZATION_ID),
          Map.entry("userId", USER_ID),
          Map.entry("userName", USER_NAME),
          Map.entry("jobTitle", JOB_TITLE),
  ...
  public static final Map<String, String> ALLOWED_FILTER_MAP_FOR_ORG_CREATE_REQUEST = Map.ofEntries(
          Map.entry("orgName", ORG_NAME),
          Map.entry("entityType", ENTITY_TYPE),
          Map.entry("orgSector", ORG_SECTOR),
          Map.entry("status", STATUS),
  ...
  public static final Map<String, String> ALLOWED_FILTER_MAP_FOR_PROVIDER_ROLE_REQUEST = Map.ofEntries(
          Map.entry("userId", USER_ID),
  ...
  public static final Map<String, String> ALLOWED_FILTER_MAP_FOR_COMPUTE_ROLE = Map.ofEntries(
          Map.entry("userId", USER_ID),
          Map.entry("userName", USER_NAME),
          Map.entry("status", STATUS),
