...
public class ControllerFactory {
  ...
  public static List<ApiController> createControllers(Vertx vertx, JsonObject config) {
    ...
    EmailHelper emailHelper = new EmailHelper(organizationService,userService);
    ...
    ApiController organizationController = OrganizationControllerFactory.create(organizationService, userService,emailHelper,emailService);
